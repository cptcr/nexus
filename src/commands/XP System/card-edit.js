...
module.exports = {
    ...
    .addSubcommand(command => command.setName("level-color").setDescription("Edit the bar color of your default card image").addStringOption(option => option.setName("color").setDescription("Please set the hex code of your color here").setMinLength(7).setMaxLength(7).setRequired(true)))    
    .addSubcommand(command => command.setName("track-color").setDescription("Edit the bar color of your default card image").addStringOption(option => option.setName("color").setDescription("Please set the hex code of your color here").setMinLength(7).setMaxLength(7).setRequired(true))),
