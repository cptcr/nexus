...
module.exports = {
    ...
    .addSubcommand(command => command.setName("invite").setDescription("invite this bot"))//
    .addSubcommand(command => command.setName("review-topgg").setDescription("Review this bot at top.gg"))//done
    .addSubcommand(command => command.setName("set-nickname").setDescription("Set the bots nickname for this server").addStringOption(option => option.setName('nickname').setDescription(`The nickname you want your bot to get`).setRequired(true)))
    .addSubcommand(command => command.setName("uptime").setDescription("The Bots uptime"))//done
    .addSubcommand(command => command.setName("version").setDescription("Current Version and Features"))
